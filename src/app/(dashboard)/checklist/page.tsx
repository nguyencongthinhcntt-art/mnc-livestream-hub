...
// import LivestreamSelector from '../planning/LivestreamSelector';
...
//   const tasks = planningData?.checklists || [];
...
//             <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Checklist Quản Lý Công Việc</h1>
...
//             </span>
//           </div>
//           <p className="text-sm text-slate-500 mt-1">Chuẩn hóa quy trình vận hành trước, trong và sau phiên Livestream</p>
//         </div>
...
//           <p className="text-slate-600 font-semibold">Chưa chọn phiên livestream hợp lệ hoặc chưa có dữ liệu.</p>
//         </div>
//       ) : (
//         <>
//           {/* THANH TIẾN ĐỘ */}
...
//               <span>TIẾN ĐỘ HOÀN THÀNH TOÀN BỘ PHIÊN</span>
...
//           {/* FORM THÊM CÔNG VIỆC */}
//           <form action={addTaskItem} className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-5 gap-3 items-center">
//             <input type="hidden" name="livestreamId" value={selectedId} />
            
//             <select name="phase" className="border border-slate-200 rounded-xl px-3 py-2 text-sm outline-none bg-slate-50 font-semibold text-slate-700">
...
//               required 
//               className="border border-slate-200 rounded-xl px-3 py-2 text-sm outline-none bg-slate-50 md:col-span-2 focus:bg-white transition-colors" 
//             />
...
//               className="border border-slate-200 rounded-xl px-3 py-2 text-sm outline-none bg-slate-50 focus:bg-white transition-colors" 
//             />

//             <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-bold py-2.5 flex items-center justify-center gap-1.5 transition-colors shadow-sm cursor-pointer">
...
// // --- SUB COMPONENT ĐÃ LOẠI BỎ EVENT HANDLER THỪA ---
...
//               {/* Form Checkbox */}
//               <form action={onToggle.bind(null, item.id, item.isCompleted)} className="flex items-center gap-3 flex-1 cursor-pointer">
//                 <button type="submit" className="flex items-center justify-center cursor-pointer p-1 -m-1">
//                   <input
//                     type="checkbox"
...
//                   />
//                 </button>
//                 <span className={`text-sm font-medium ${item.isCompleted ? 'line-through text-slate-400' : 'text-slate-900'}`}>
//                   {item.taskName}
//                 </span>
//               </form>
...
//                   <button type="submit" className="text-slate-300 hover:text-rose-500 transition-colors cursor-pointer p-1" title="Xóa task">
//                     <Trash2 size={15} />
//                   </button>
//                 </form>
//               </div>
